...
class ReconstructionChecks(unittest.TestCase):
    ...
    def test_same_distance_different_peaks(self):
        # Triangle occupies tau seconds, with rest for the rest of the 25 s.
        # All are mathematical alternatives, not physically validated craft.
...
if __name__ == "__main__":
    a, v = triangular_motion(28000 * .3048, .78)
    print(f"Conditional descent: a={a/9.80665:.6f} g, peak={v:.6f} m/s")
    print(f"Sonar average: {2500/25:.6f} m/s, {2500/25/.44704:.6f} mph")
    a, v = triangular_motion(2500, 25)
    print(f"Conditional sonar rest-to-rest: a={a:.6f} m/s2, peak={v:.6f} m/s")
    unittest.main()
